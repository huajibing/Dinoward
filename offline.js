...
class LoadTimeData {
  ...
  const pageData = {"dinoGameA11yAriaLabel":"Dinoward, Play","dinoGameA11yDescription":"Dinoward。在这款游戏中，您要协助正在荒野中奔跑的像素化Edward躲避仙人掌和翼手龙。您只需在听到提示音时按一下空格键，即可让Edward跃过障碍物。","dinoGameA11yGameOver":"游戏结束，您的得分是 $1。","dinoGameA11yHighScore":"您的最高得分是 $1。","dinoGameA11yJump":"跳！","dinoGameA11ySpeedToggle":"启用慢速模式","dinoGameA11yStartGame":"游戏已开始。","errorCode":"","fontfamily":"'Segoe UI',Arial,'Microsoft Yahei',sans-serif","fontsize":"75%","heading":{"hostName":"dino","msg":"按空格键即可开始游戏"},"iconClass":"icon-offline","language":"zh","textdirection":"ltr","title":"chrome://dino/"};loadTimeData.data = pageData;var tp = document.getElementById('t');jstProcess(new JsEvalContext(pageData), tp);
